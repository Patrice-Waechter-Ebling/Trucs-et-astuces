# Installer Microsoft SQL Serveur sous Linux 
## Édition 2025
+ sudo su
...
# Installer la recherche en texte intégral SQL Server
+ sudo apt-get update
+ sudo apt-get install -y mssql-server-fts

# Installer SQL Server Integration Services (SSIS)
+ curl https://packages.microsoft.com/keys/microsoft.asc | sudo tee /etc/apt/trusted.gpg.d/microsoft.asc
...
# Installation de l’extension de langage Java SQL Server
